...
#SBATCH -N 1
#SBATCH --mem=30G
#SBATCH --output=training_mouse_b512_out.txt
#SBATCH --error=training_mouse_b512_err.txt
...
python3 run/run.py configs/mouse_configs/configs_mouse_temp50.0_b512.yaml